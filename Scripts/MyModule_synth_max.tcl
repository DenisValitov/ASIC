...
include ../Scripts/Technology/X-FAB_max.tcl
## Setup variables
set DESIGN filter
set PARAMS {}
...
report area > ../Reports/Synthesis/Top_synth_area_report_max
report timing > ../Reports/Synthesis/Top_synth_timing_report_max
...
write_sdc > ../Outputs/Synthesis/Top_out_max.sdc
