// -------------------------------------------------------------
// 
// File Name: hdlsrc/Model_fixed_point_VHDL/filter_tb.v
// Created: 2020-12-21 01:04:27
// 
...
module filter_tb;
  ...
  reg [14:0] output_rsvd_addr;  // ufix15
  ...
  reg [14:0] Signal_From_Workspace_out1_addr;  // ufix15
  wire Signal_From_Workspace_out1_active;  // ufix1
  wire Signal_From_Workspace_out1_enb;  // ufix1
  wire [14:0] Signal_From_Workspace_out1_addr_delay_1;  // ufix15
  ...
  wire [14:0] output_rsvd_addr_delay_1;  // ufix15
  ...
  assign Signal_From_Workspace_out1_enb = Signal_From_Workspace_out1_active & (rdEnb & tb_enb);
  ...
  always @(Signal_From_Workspace_out1_addr_delay_1, rdEnb, tb_enb)
    begin
      if (tb_enb == 0) begin
  ...
  always @(output_rsvd_addr_delay_1, rdEnb, tb_enb)
    begin
      if (tb_enb == 0) begin
